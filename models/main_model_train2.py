...
def myModel():
    ...
    no_Of_Nodes = 800  # NO. OF NODES IN HIDDEN LAYERS
    model = Sequential()
    ...
    model.add(Dropout(0.3))  # INPUTS NODES TO DROP WITH EACH UPDATE originaldataset ALL originaldataset NONE
    model.add(Dense(noOfClasses, activation='softmax'))  # OUTPUT LAYER
    # COMPILE MODEL
    model.compile(Adam(lr=0.008), loss='categorical_crossentropy', metrics=['accuracy'])
    return model
