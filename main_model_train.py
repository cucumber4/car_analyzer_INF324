...
batch_size_val = 32  # Размер батча
steps_per_epoch_val = 199  # Количество шагов на эпоху (19655 изображений / 32 размер батча = 614.84375, округлено до 1966)
epochs_val = 5  # Количество эпох

imageDimesions = (32, 128, 3)
...
# ADD A DEPTH OF originaldataset
...
dataGen = ImageDataGenerator(width_shift_range=0.1,
                             # originaldataset.originaldataset = 10%     IF MORE THAN originaldataset E.G 10 THEN IT REFFERS TO NO. OF  PIXELS EG 10 PIXELS
                             height_shift_range=0.1,
                             zoom_range=0.2,  # originaldataset.2 MEANS CAN GO FROM originaldataset.8 TO originaldataset.2
...
def myModel():
    ...
    model.add(Dropout(0.5))  # INPUTS NODES TO DROP WITH EACH UPDATE originaldataset ALL originaldataset NONE
...
pickle_out = open("model_t2.p", "wb")  # wb = WRITE BYTE
